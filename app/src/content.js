...
export const content = {
  ja: {
    ...
    hero: {
      ...
      usp: "海外講師 × 日本人通訳者",
      title: ["いつでも どこでも", "話す力に", "確かな自信を"],
      goldLine: 2,
      sub: "海外講師と日本人通訳者がふたりで並走するオンライン英語レッスン\n初心者でも置いていかれず 話す力が静かに育ちます",
      primary: "無料体験を予約する",
      secondary: "特長を見る",
    },
    difference: {
      ...
      body: "海外講師の自然な英語に触れながら つまずいた瞬間は日本人通訳者がすぐ隣でフォロー\n最初のレッスンから安心して話せます",
      points: [
        { title: "通訳者がすぐ隣に", body: "わからない時は日本語で確認できるから 会話が途切れません" },
        { title: "ネイティブの自然な英語", body: "教科書では学べない 実際の会話で使う表現と発音が身につきます" },
        { title: "アウトプット中心", body: "受講者が主役 話す時間を最大化して 成長を実感できます" },
      ],
      stats: [
    ...
    features: {
      eyebrow: "Why TSC",
      title: "TSC English Academy が選ばれる理由",
      sub: "信頼 柔軟性 成果\nあなたの上達のための選択を",
      items: [
        { no: "01", tag: "少人数制", title: "発話量を最大化", body: "ひとりひとりが話す時間を確保 アウトプット中心で確かに伸びます" },
        { no: "02", tag: "柔軟スケジュール", title: "オンライン or 対面", body: "暮らしに合わせて学ぶ いつでもどこからでも受講できます" },
        { no: "03", tag: "目的別", title: "カリキュラム設計", body: "留学 受験 ビジネス それぞれの目標に合わせて最適化します" },
      ],
    },
    showcase: {
      eyebrow: "教室の風景",
      title: ["画面の向こうに", "本物の学びを"],
      body: "自宅にいながら 海外講師と通訳者が並ぶ本物のレッスン空間へ\n落ち着いた環境で 話す力を磨いていきます",
      items: [
        { src: "lesson3.jpg", label: "集中できる学習環境" },
        { src: "lesson1.jpg", label: "海外講師とのオンラインレッスン" },
        { src: "lesson2.jpg", label: "手を動かして身につける" },
      ],
    },
    pricing: {
      eyebrow: "Pricing",
    ...
    faq: {
      ...
      items: [
        { q: "初心者でも大丈夫ですか", a: "はい 完全初心者から上級者まで対応しています\n通訳者が同席するため 英語に不安がある方でも安心です\n無料体験で最適な進め方をご提案します" },
        { q: "オンラインと対面は切り替えできますか", a: "はい スケジュールに合わせて柔軟に選んでいただけます" },
        { q: "教材はどうなりますか", a: "目的に合わせて最適な教材をご提案します\n無料体験時に詳しくご案内します" },
        { q: "通訳者は毎回同席しますか", a: "レベルやご希望に応じて柔軟に対応します\n最初は手厚く 慣れてきたら英語中心へ\nあなたの成長に合わせて調整していきます" },
      ],
    },
    apply: {
      eyebrow: "Apply",
